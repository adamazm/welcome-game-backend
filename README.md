...
This is a backend server for Welcome Game.
...
https://www.dinocajic.com/add-xampp-php-to-enviroment-variables-in-windows-10/

## Installation

1. Clone the repository onto your machine.
2. Create a new database called `welcomegame_db` and for an easy installation, make sure you have a root user without any password. If you do have a certain user you want to associate with the this API, refer to further steps.
3. Open the cloned repository in your preferred text editor (VSCode, etc.) and run this command to create a new `.env` file :
